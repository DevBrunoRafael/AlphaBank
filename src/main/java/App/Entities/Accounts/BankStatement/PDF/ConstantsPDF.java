...
public class ConstantsPDF {
    ...
    public static Font FONT_RED = new Font(Font.FontFamily.HELVETICA, 12, Font.NORMAL, BaseColor.RED);
    public static Font FONT_BLUE = new Font(Font.FontFamily.HELVETICA, 12, Font.NORMAL, BaseColor.BLUE);
